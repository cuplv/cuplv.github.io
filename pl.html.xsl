...
<xsl:variable name="pages">
  ...
  <page>
    ...
    <content>
      ...
      <p>CUPLV is located in the Engineering Center at
      ...
      <p>The main entrance of the Engineering Center is on the west side (next to the coffee shop). From this entrance, the Office Tower (ECOT) elevators are immediately to your left, and the Computer Science wing (ECCS) is found by going right and following signs.</p>
      ...
      <p>To get from the airport, here are some options:
        <ul>
	  <li>Take the <a href="http://greenrideboulder.com/">Green Ride</a> airport shuttle. It's $30.00 one way.</li>
          <li>Rent a car.  It is usually pretty inexpensive.  You need to take an airport bus to the rental car center.</li>
          <li>Take the express <a href="http://www.rtd-denver.com/skyride.shtml">RTD SkyRide</a> bus: <a href="http://www3.rtd-denver.com//schedules/getSchedule.action?routeType=9&amp;routeId=AB">AB route</a>.  It goes directly from the airport, by campus, and ends in downtown Boulder.  If you stay at the Hotel Boulderado, the downtown transit center where the bus ends is only a few blocks from the hotel. The fare is $13.00 one way and departs at least once an hour. There are signs for this bus in the airport terminal.</li>
      ...
      <p>Getting around Boulder by bus is quite easy. RTD is the transit system in the Denver-Boulder area, and there is an express bus between downtown Denver and the CU-Boulder campus (the <a href="http://www3.rtd-denver.com/schedules/getSchedule.action?routeType=0&amp;routeId=B">BV/BX/BMX</a> route with the BX and BMX being express routes).  You would get off at Broadway and Regent or Broadway and Euclid and then walk 10-15 minutes across campus to the Engineering Center. The easiest way to get bus directions is to use Google Maps.</p>
      <p>If you are going to ride the bus several times, RTD sells a 10-ride ticketbook. It is a slight discount over the cash fare. There's a ticket counter at the airport around where you come up from train in
the main terminal.</p>
	...
	The Millennium Harvest is fine, nothing special, but it is very convenient to the department (almost right next to it).
      </p>
      <p>
